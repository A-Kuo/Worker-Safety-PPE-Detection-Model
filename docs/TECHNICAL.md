# Technical Reference — Unified Multi-Domain PPE Compliance Detection

> 👋 Looking for the plain-English overview, screenshots, and "how do I run this" guide? Start at the [project README](../README.md) instead. This page is the deep technical reference: data, schema, training grid, math, and evaluation protocol.
...
| **Inherited baseline** | Construction YOLOv8n — mAP50 **0.809**, mAP50-95 **0.507** ([baseline.md](baseline.md)) |
...
Configs: [`configs/data/`](../configs/data/). Distribution notes: [`data_distribution.md`](data_distribution.md).
...
| Protocol | [`experiments.md`](experiments.md) |
...
From [`baseline.md`](baseline.md) / inherited `results.csv` (epoch 99):
